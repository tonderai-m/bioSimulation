...
@#$#@#$#@
<experiments>
  <experiment name="experiment-scene-7a" repetitions="13" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="experiment-scene-7b" repetitions="13" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>Average-Amount-LogCFU-L0</metric>
    <metric>Average-Amount-LogCFU-L1</metric>
